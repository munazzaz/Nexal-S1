...
//     // We call the same facebookSearch API, passing the numeric ID as "username"
...
//   // The API response object always contains these keys:
//   const {
//     name,
//     image,
//     intro,
//     about_public = [],
//     // followers/following not returned by this endpoint; show N/A
//     followers_count = "N/A",
//     following_count = "N/A",
//   } = data;

//   return (
//     <div className="max-w-md mx-9 bg-white shadow-lg rounded-lg overflow-hidden mb-8">
...
//           />
//         ) : (
//           <div className="w-24 h-24 rounded-full bg-gray-200 flex items-start">
...
//           {name || "Unknown"}
//         </h2>
//         <p className="text-sm text-gray-500">Name: {profileId}</p>

//         {/* BIO / INTRO */}
//         {intro && (
//           <p className="mt-2 text-center text-gray-600 whitespace-pre-wrap">
//           {intro}
//           </p>
//         )}
...
//         {/* PUBLIC INFO (location, category, links) */}
//         {/* 
